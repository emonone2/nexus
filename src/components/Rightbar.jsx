                ...
                >
                  <div className="flex items-center gap-3 mb-2.5">
                    ...
                    <div className="min-w-0 flex-1">
                      <h6 className="font-bold text-xs text-slate-900 dark:text-slate-100 truncate">
                        {req.name}
                      </h6>
        ...
        <div className="space-y-1">
          {friendsList.map((friend) => (
            <motion.button
              ...
              className="w-full flex items-center justify-between p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800/40 transition-colors text-left group cursor-pointer"
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="font-bold text-xs text-slate-800 dark:text-slate-200 group-hover:text-indigo-500 transition-colors truncate">
                    {friend.name}
                  </p>
